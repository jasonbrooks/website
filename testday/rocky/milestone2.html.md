---
layout: default
permalink: /testday/rocky/milestone2/
...
* [Workarounds](https://etherpad.openstack.org/p/rdo-test-days-rocky2-workarounds)
...
[workarounds](https://etherpad.openstack.org/p/rdo-test-days-rocky2-workarounds) page for problems that others may have encountered and resolved.)
...
check the [workarounds](https://etherpad.openstack.org/p/rdo-test-days-rocky2-workarounds) page for things that may have already have fixes or workarounds.
